...
async def t_shirt(callback: CallbackQuery):
    await callback.answer(text='ABOBA')  # на колбэк всегда нужно отвечать колбэком а не сообщением. Это верный вариант, свечение пропадет. Можно указать текст
    ...
    # await callback.answer(text='ABOBA', show_alert=True)  # более навязчивый ответ с уведомлением
